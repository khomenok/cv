...
For me, the purpose of development is not only the code but also making it easy for others to use.\\
It is cool to create processes where responsibilities and knowledge are shared and not tied to a particular person.\\
That's why, along with features, I like to build CI\&CD, write documentation and help juniors to get into the flow. \\
...
\begin{entrylist}
    ...
    {Optima}
    {\noindent{Building the Energy Management System from zero into a scalable system}
        \begin{itemize}[noitemsep,topsep=5pt,leftmargin=8pt]
            \item Architected a system for managing custom connected devices logic
            \item Developed a system orchestrating different communication protocols like Modbus or EEBus
            \item Developed of web and mobile applications from ground zero
            \item Maintained a codebase in LLM-friendly way, took all accountability for the code as human
        \end{itemize}
        \texttt{TypeScript}\slashsep\texttt{DotNet}\slashsep\texttt{Postgres}\slashsep\texttt{Timescale DB}\\
        {\color{gray}\texttt{Energy Management}\slashsep\texttt{Modbus}}}
    \entry
    {2024 -- 2025}
    {Staff Engineer}
    {Lemony.ai}
    {\noindent{Led engineering of secure, offline LLM solutions bridging hardware, software and cloud}
        \begin{itemize}[noitemsep,topsep=5pt,leftmargin=8pt]
            ...
            \item Architected a FE/Desktop app platform, enabling rapid development of secure offline UIs
        ...
        \end{itemize}
        \texttt{TypeScript}\slashsep\texttt{DotNet}\slashsep\texttt{LLMs}\slashsep\texttt{RAG}\slashsep\texttt{GCP}\\
    ...
    {\noindent{Modernized a legacy monolith into a scalable, developer- and product-friendly frontend platform}
        \begin{itemize}[noitemsep,topsep=5pt,leftmargin=8pt]
            ...
            \item Built a modular Next.js frontend with A/B testing and multi-country feature toggles
        \end{itemize}
...
\begin{minipage}[t]{0.6\textwidth}
	...
	\textbf{Russian} - C2\slashsep\textbf{English} - B2 (IELTS - C1 c:)\slashsep\textbf{German} - A2
\end{minipage}
